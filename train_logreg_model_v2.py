...
os.environ["AWS_ACCESS_KEY_ID"] = env.get("S3_ACCESS_KEY", env.get("AWS_ACCESS_KEY_ID"))
os.environ["AWS_SECRET_ACCESS_KEY"] = env.get("S3_SECRET_KEY", env.get("AWS_SECRET_ACCESS_KEY"))
...
model = Pipeline(
    steps=[
        ...
        ("classifier", LogisticRegression(max_iter=1000, C=0.5, class_weight="balanced", random_state=42)),
    ]
)
